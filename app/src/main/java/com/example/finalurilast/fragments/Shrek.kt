...
class Shrek:Fragment(R.layout.shrek_layout) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        back = view.findViewById(R.id.shrekBack)
        buy = view.findViewById(R.id.shrekBuy)
    ...
    private fun dialog() {
        ...
        yesButton.setOnClickListener {
            ...
            if (filmName.text.toString().isEmpty() || ticket.text.toString().isEmpty()) {
                ...
                Toast.makeText(activity, "You have bought the ticket", Toast.LENGTH_SHORT)
                    .show()
